...
from app.modules.admin.controller import (
    ...
    reingresos_usuarios, actividad_temporal, reconciliar_inactividad_usuarios,
)
...
admin_bp.post("/usuarios/reconciliar-inactividad")(jwt_required()(reconciliar_inactividad_usuarios))
